...
class SensorStreaming(object):
    ...
    def StreamLidarSensor(request_iterator,
        ...
        return grpc.experimental.stream_unary(request_iterator, target, '/sensorstreaming.SensorStreaming/StreamLidarSensor',
            sensor__streaming__pb2.PointCloudStreamingRequest.SerializeToString,
            std__pb2.Empty.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def StreamSonarImage(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/sensorstreaming.SensorStreaming/StreamSonarImage',
            sensor__streaming__pb2.CompressedImageStreamingRequest.SerializeToString,
            std__pb2.Empty.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def StreamPointCloud(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/sensorstreaming.SensorStreaming/StreamPointCloud',
            sensor__streaming__pb2.PointCloudStreamingRequest.SerializeToString,
            std__pb2.Empty.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def StreamPointCloud2(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/sensorstreaming.SensorStreaming/StreamPointCloud2',
            sensor__streaming__pb2.PointCloud2StreamingRequest.SerializeToString,
            std__pb2.Empty.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def RequestPointCloud2(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
