...
class SimulationControl(object):
    ...
    def Step(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/simulationcontrol.SimulationControl/Step',
    ...
    def SetStartTime(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/simulationcontrol.SimulationControl/SetStartTime',
