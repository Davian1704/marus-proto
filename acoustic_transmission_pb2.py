...
AcousticResponse = _reflection.GeneratedProtocolMessageType('AcousticResponse', (_message.Message,), {
...
AcousticRequest = _reflection.GeneratedProtocolMessageType('AcousticRequest', (_message.Message,), {
