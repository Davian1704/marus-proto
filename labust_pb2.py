...
_POINTERPRIMITIVESERVICE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='streamlineOrientation', full_name='labust.PointerPrimitiveService.streamlineOrientation', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='guidanceTopic', full_name='labust.PointerPrimitiveService.guidanceTopic', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='radiusTopic', full_name='labust.PointerPrimitiveService.radiusTopic', index=7,
