...
_NAVIGATIONSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='orientation_rate', full_name='auv.NavigationStatus.orientation_rate', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='position_variance', full_name='auv.NavigationStatus.position_variance', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='orientation_variance', full_name='auv.NavigationStatus.orientation_variance', index=9,
...
_NAVIGATIONSTATUS.fields_by_name['orientation_rate'].message_type = geometry__pb2._VECTOR3
_NAVIGATIONSTATUS.fields_by_name['position_variance'].message_type = _NED
_NAVIGATIONSTATUS.fields_by_name['orientation_variance'].message_type = geometry__pb2._VECTOR3
